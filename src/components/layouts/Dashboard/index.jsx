            ...
            <div className="row">
              <div className="col-sm-3 col-md-2 sidebar">
                <div className="text-center">
                  <h2 className="brand">Concrete<br /><small>DevOps</small></h2>
                  <img src={require("../../../common/images/flat-avatar.png")} className="user-avatar" />
                  <br />
                  <Link to="/login" className="btn btn-white btn-outline btn-rounded btn-sm">Sair</Link>
                </div>

                <ul className="nav nav-sidebar">
                  <li>
                    <Link to="/dashboard/overview">Sobre</Link>
                  </li>
                  <li>
